...
<head>
    ...
    <style>
        ...
        .service__list li section h4 {
            font-size: 16px;
            font-weight: 600;
            color: #000;
        }

        .service__list li section h5 {
            font-size: 12px;
...
<div class="wrap">
    ...
    <div class="main__title"><img src="/mtx/public/img/service-banner.jpg" alt=""></div>
    <div class="main__con">
        <ul class="service__list clearfix">
            @foreach($data as $key => $value)
                <li class="fl">
                    <a href="{{ url('home/product/serviceDetails/'.$value->id) }}">
                        <div>
