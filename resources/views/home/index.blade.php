        ...
        <ul class="box__list">
            <li>
                <div class="item__color">
                    ...
                    <p>${{ $industryData->auto_parts or '0' }}</p>
                </div>
                <section>
                    <h4>汽车配件</h4>
                    <h5>成交数据总额${{ $industryData->auto_parts or '0' }}</h5>
                </section>
            </li>
            <li>
                <div class="item__color">
            ...
            <div class="roll__wrap">
                <ul class="roll__list">
                    @foreach($rollData as $key => $value)
                        <li>{{ $value->created_at }}，{{ $value->product_name }}，{{ $value->trade_name }}，${{ $value->amount }}，{{ $value->country }}，{{ $value->corporate_name }}</li>
                    @endforeach
                </ul>
            </div>
